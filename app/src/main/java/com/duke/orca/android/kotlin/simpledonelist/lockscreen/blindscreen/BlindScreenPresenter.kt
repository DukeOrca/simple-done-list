package com.duke.orca.android.kotlin.simpledonelist.lockscreen.blindscreen
...
import com.duke.orca.android.kotlin.simpledonelist.databinding.BlindScreenBinding
...
class BlindScreenPresenter {
    ...
    private fun navigationBarHeight(): Int {
        ...
        if (identifier > 0) return resources.getDimensionPixelSize(identifier)
